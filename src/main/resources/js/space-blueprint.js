...
AJS.toInit(function($) {
    ...
    function helloPagePostRender(e, state) {
        ...
        if (state.wizardData.title) {
            state.$container.find('#space-blueprint-page-title').val(state.wizardData.title);
        }
    }
    ...
    function searchFormPostRender(e, state) {
        state.$container.append(AJS.I18n.getText('confluence.space.blueprint.form.append.postrender'));
    }
